const CACHE_VERSION = "stock-assets-pwa-v5.2.0-safe-test-trash-20260801";
...
const APP_SHELL = [
  ...
  "./assets/tailwind.css?v=5.2.0",
  "./assets/app.css?v=5.2.0",
  "./assets/app.js?v=5.2.0",
  "./assets/pwa.js?v=5.2.0",
  "./icons/icon-192.png?v=5.2.0",
  "./icons/icon-512.png?v=5.2.0",
  "./icons/icon-maskable-512.png?v=5.2.0",
  "./icons/favicon-64.png?v=5.2.0"
];
...
self.addEventListener("fetch", event => {
  ...
  // app.css、app.js、pwa.js 與 Tailwind 採網路優先；v5.2 採網路優先，並保留完整 Tailwind 樣式。
