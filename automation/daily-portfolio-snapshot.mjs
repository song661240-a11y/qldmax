...
async function processQqqiE2eDashboard(db, ref, targetDate) {
  ...
  const distribution={symbol:"QQQI",declarationDate:entitlementDate,exDate:targetDate,recordDate:targetDate,payableDate:targetDate,amountPerShare:0.6346,source:"v6.2 isolated fixture"};
